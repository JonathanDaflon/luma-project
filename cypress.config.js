...
var browserify_preprocessor_1 = require("@cypress/browserify-preprocessor");
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                return [4 /*yield*/, (0, cypress_cucumber_preprocessor_1.addCucumberPreprocessorPlugin)(on, config)];
                case 1:
                    // This is required for the preprocessor to be able to generate JSON reports after each run, and more,
                    _a.sent();
